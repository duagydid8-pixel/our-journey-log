...
const notes = [
  {
    sender: "H",
    content: "후쿠오카에서 먹은 라멘이 아직도 생각나. 다음에 또 가자.",
    date: "2025.01.15",
  },
  {
    sender: "J",
    content: "태안 바다에서 본 석양이 가장 좋았어.",
    date: "2025.02.03",
  },
  {
    sender: "H",
    content: "제주도 오름 위에서 바람 맞던 거 기억나? 머리가 다 날아갈 뻔했잖아.",
    date: "2025.03.10",
  },
  {
    sender: "J",
    content: "다음 여행은 어디로 갈까. 오사카도 좋을 것 같아.",
    date: "2025.03.14",
  },
  {
    sender: "H",
    content: "매일 같이 산책하는 것도 여행이지.",
    date: "2025.03.15",
  },
];
