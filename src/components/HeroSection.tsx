...
const getDaysTogether = () => {
  const now = new Date();
  return Math.floor((now.getTime() - START_DATE.getTime()) / (1000 * 60 * 60 * 24));
};
  ...
  return (
    <section className="relative bg-hero-bg pt-14 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 md:py-32">
        ...
        >
          <path
            d="M 80 150 Q 200 50 300 100 Q 400 150 520 60"
            fill="none"
            stroke="hsl(20 40% 50%)"
            strokeWidth="1.5"
            strokeDasharray="4 4"
        ...
        >
          <div className="flex-1 bg-surface/80 backdrop-blur-sm border border-border p-6 md:p-8 text-center">
            ...
            <p className="text-[11px] text-taupe mt-2">2021.05.20 ~</p>
          </div>
          <div className="flex-1 bg-surface/80 backdrop-blur-sm border border-border p-6 md:p-8 text-center">
            ...
            <p className="text-[11px] text-taupe mt-2">후쿠오카</p>
          </div>
        </motion.div>
      </div>
    </section>
